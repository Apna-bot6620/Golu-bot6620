...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "🥺🥺🥺") || (event.body.toLowerCase() == "🥺🥺") || (event.body.toLowerCase() == "🥺") || (event.body.toLowerCase() == "🥺🥺🥺🥺")) {
     return api.sendMessage("️ҡɣʌ 卄𝖚ʌ , 𝐑𝐎 𝐊𝐘𝐔 𝐑𝐄𝐇𝐄 𝐇𝐎 , 𝐌𝐄 𝐇𝐔 𝐍𝐀 𝐓𝐎 𝐅𝐇𝐈𝐑 𝐊𝐘𝐔 𝐑𝐎𝐍𝐀 . 𝐑𝐔𝐊𝐎 𝐌𝐄 𝐀𝐁𝐇𝐈 𝐂𝐇𝐎𝐂𝐎𝐋𝐀𝐓𝐄 𝐃𝐄𝐓𝐀 𝐇𝐔 𝐋𝐈𝐊𝐇𝐎 🍫  ☞Chocolate☜", threadID);
   };

   if ((event.body.toLowerCase() == "😏") || (event.body.toLowerCase() == "😏😏")) {
     return api.sendMessage("️┼ʌʌ 卄𝖚ʌ ɮʌɮ𝖚 🤔🤟", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Bot I miss you") || (event.body.toLowerCase() == "BOT I MISS YOU")) {
  ...
  if ((event.body.toLowerCase() == "😂") || (event.body.toLowerCase() == "😂😂") || (event.body.toLowerCase() == "😂😂😂") || (event.body.toLowerCase() == "😂😂😂😂") || (event.body.toLowerCase() == "😂😂😂😂😂") || (event.body.toLowerCase() == "😂😂😂😂😂😂")) {
   ...
   if ((event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😍😍😍😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "😍😍")) {
     return api.sendMessage("卄ʌʌɣ 🦋 ɭʌɮɮʌ 🥀 inna pyar🙊🙊", threadID);
   };

   if ((event.body.toLowerCase() == "@Shruti Ahuja") || (event.body.toLowerCase() == "@Sardarni Jatti") || (event.body.toLowerCase() == "@Chułbułıı Chørıı") || (event.body.toLowerCase() == "@Sohna Kmla ") || (event.body.toLowerCase() == "@Mahadev Ki Dewani")) {
  ...
  if ((event.body.toLowerCase() == "love you") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("Hmm..ɭ❍ⓥɘ ɣ❍𝖚 ┼❍❍ ɮʌɮɣ 💋😘:))", threadID);
   };
